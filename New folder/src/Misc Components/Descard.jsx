...
export default function Descard({ imageArray, shoename, id ,count,setCount}) {
    ...
    const handleData = () => {
        ...
        // const collectionref = collection(database, 'cart');
        // addDoc(collectionref, { cart }).then(() => {
        //     alert("data added");
        // }).catch((err) => {
        //     alert(err.message);
        // })
            ...
            <section id="shop-products">
                ...
                <div className="right-container">
                    <div className="description">
                        ...
                        <div className="quantity">
                            <h4>Quantity</h4>
                            <input type="number" value={quantity} onChange={(e)=>setQuantity(e.target.value)} name="" id="" />
                        </div>
