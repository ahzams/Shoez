            ...
            <div className="signin-signup">
                ...
                <form action="" className="signup-form" id="sign-up">
                    ...
                    <div className="form-control">
                        ...
                        <input className="input-text" type="text" placeholder="Username" onChange={(e) => setUsername(e.target.value)} />
                    </div>
                    ...
                    <div className="login-btn">
                        <button className="btn" onClick={handleSubmit}>Create an Account</button>
                    </div>
