...
export default function Navbar({ count,page }) {
    ...
    return (
        <div className='nav-Section'>
            <nav className="navbar" id='header'>
                ...
                <div className="icons">
                    <div style={{ display: "flex", alignItems: "center" }} onClick={() => navigate("/Login")}><span className="material-icons">account_circle</span>SIGN IN</div>
